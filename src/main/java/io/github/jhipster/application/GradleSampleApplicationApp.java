...
public class GradleSampleApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(GradleSampleApplicationApp.class);

    private final Environment env;

    public GradleSampleApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes gradleSampleApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GradleSampleApplicationApp.class);
